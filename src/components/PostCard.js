        ...
        <div className={styles.cardcontent}>
          ...
          <div className={styles.cardactions}>
            ...
            <div className={styles.cardshare}>
              ...
              <FacebookShareButton url={`https://www.caricode.co/${slug}/`} style={{height: '24px'}}>
                <FacebookIcon size={24} round bgStyle={{fill: 'lightgray'}}/>
              </FacebookShareButton>
              <EmailShareButton url={`https://www.caricode.co/${slug}/`} style={{height: '24px'}}>
                <EmailIcon size={24} round bgStyle={{fill: 'lightgray'}}/>
              </EmailShareButton>
              <WhatsappShareButton url={`https://www.caricode.co/${slug}/`} style={{height: '24px'}}>
                <WhatsappIcon size={24} round bgStyle={{fill: 'lightgray'}}/>
              </WhatsappShareButton>
              <TwitterShareButton url={`https://www.caricode.co/${slug}/`} style={{height: '24px'}}>
