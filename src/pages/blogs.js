    ...
    <Layout>
      ...
      <div className={styles.main}>
        ...
        <div className={styles.ctrtable}>
          <h2>Click through rate changes based on position</h2>
          <table>
            <thead>
              <tr>
        ...
        <div className={styles.snippets}>
          ...
          <div className={styles.inner}>
            ...
            speed. In addition, a slow page speed means that search engines can
            crawl fewer pages using their allocated crawl budget, and this could
        ...
        <div className={styles.socialsharing}>
          <div className={styles.inner}>
            ...
            sharing. That's how social media affects SEO because all of this
            sharing adds up to more visibility for your content. If lots of
            people share your content on social media, then it's likely more
            people will link to it, and links ARE a hugely important SEO ranking
            factor.
          </div>
        </div>
        <div className={styles.algodata}>
          <div className={styles.inner}>
            ...
            of these changes are minor, Google occasionally rolls out a major
            algorithmic update (such as Panda and Penguin) that affects search
            results in significant ways. For search marketers, knowing when
            major Google updates happened can help explain changes in rankings
            and organic website traffic and ultimately improve search engine
            optimization.
            <br />
            <br />
