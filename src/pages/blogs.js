      ...
      <div className={styles.main}>
        ...
        <div className={styles.section2}>
          ...
          <div className={styles.socialsharing}>
            <div className={styles.inner}>
              <h3>Importance of social sharing</h3>Social media is built for
              mass sharing. That's how social media affects SEO because all of
              this sharing adds up to more visibility for your content. If lots
              of people share your content on social media, then it's likely
              more people will link to it, and links ARE a hugely important SEO
              ranking factor.
            </div>
          </div>
