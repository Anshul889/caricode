        ...
        <div className={styles.section2}>
          ...
          <div className={styles.whyonline}>
            ...
            <div className={styles.contentmarketing}>
              <div className={styles.inner}>
                <p>
                  Good content marketing provides the following: Ideas
                  Inspiration Tips and tricks Education.
                  <br />
                  Consumers want transparency. They want to see who you really
                  are.
                  <br />
                  Customers want to interact and get to know a brand. A
                  company’s blog (or social accounts) can help show consumers
                  who they really are.
                  <br />
          ...
          <div className={styles.howblog}>
            ...
            <div className={styles.spee}>
              <div className={styles.inner}>
                ...
                <p>
                  ...
                  (and as a result, page speed) is one of the signals used by
                  its algorithm to rank pages. And research has shown that
                  Google might be specifically measuring time to first byte as
                  when it considers page speed. In addition, a slow page speed
                  means that search engines can crawl fewer pages using their
                  allocated crawl budget, and this could negatively affect your
                  indexation.
                </p>
            ...
            <div className={styles.socialsharing}>
              <div className={styles.inner}>
                ...
                <p>
                  ...
                  content on social media, then it's likely more people will
                  link to it, and links ARE a hugely important SEO ranking
                  factor.
                </p>
              </div>
            </div>
            <div className={styles.algodata}>
              <div className={styles.inner}>
                ...
                <p>
                  Each year, Google makes hundreds of changes to search. In
                  2018, they reported an incredible 3,234 updates — an average
                  of almost 9 per day, and more than 8 times the number of
                  updates in 2009. While most of these changes are minor, Google
                  occasionally rolls out a major algorithmic update (such as
                  Panda and Penguin) that affects search results in significant
                  ways. For search marketers, knowing when major Google updates
                  happened can help explain changes in rankings and organic
                  website traffic and ultimately improve search engine
                  optimization.
                  <br />
                  <br />
